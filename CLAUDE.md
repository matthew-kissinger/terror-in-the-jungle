...
| File | Lines | Location |
|------|-------|----------|
| ChunkLifecycleManager.ts | 448 | systems/terrain/ |
...
~51k lines across 249 files. Orchestrator pattern with ongoing split refactors.
