...
- **Unit tests (Vitest)** - 70 test files, 2711 tests passing (2 skipped). Coverage: Logger, Math, NoiseGenerator, ObjectPoolManager, SpatialOctree, SpatialGrid, SpatialGridManager, HeightQueryCache, ChunkWorkerPool, InfluenceMapComputations, InfluenceMapGrid, InfluenceMapSystem, TerrainMeshMerger, ImprovedChunkManager, CombatantDamage, CombatantLODManager, CombatantRenderer, CombatantCombat, CombatantSpawnManager, TicketSystem, AICoverSystem, AIStatePatrol, AIStateDefend, AIStateEngage, AIFlankingSystem, GunplayCore, GrenadeSystem, MortarSystem, PlayerMovement, PlayerController, PlayerInput, PlayerSuppressionSystem, PlayerRespawnManager, WeaponFiring, FirstPersonWeapon, AmmoSupplySystem, InventoryManager, SmokeCloudSystem, WeaponPickupSystem, ChunkVegetation, HelicopterModel, DayNightCycle, RespawnUI, GrenadeArcRenderer, FullMapSystem, HelicopterPhysics, RallyPointSystem, AICoverFinding, SandbagSystem, WeatherSystem, ImprovedChunk, FootstepAudioSystem, KillFeed, ZoneManager, PerformanceTelemetry, PlayerHealthSystem, ClusterManager, VoiceCalloutSystem, ImpactEffectsPool, WeaponRigManager, CombatantAI, BillboardBufferManager, GrenadeEffects, AudioPoolManager, SpawnPositionCalculator, CombatantMovementStates, WeaponAnimations, HelipadSystem, SquadManager, ProgrammaticGunFactory. Run `npm run test:run` to execute.
...
~53k lines across 278 files. Orchestrator pattern with ongoing split refactors.
