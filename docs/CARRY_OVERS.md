...
| KONVEYER-10 | Rest-of-scene WebGPU parity and frame-budget attribution after K0-K9 branch-review completion | cycle-2026-05-11-konveyer-scene-parity | 1 | renderer / environment / world / perf-harness | no | Gates any WebGPU production-rollout claim. Terrain color is accepted for now; active work owns vegetation/NPC washout, atmosphere/sky/cloud behavior, `World` timing decomposition, skyward triangle attribution, finite-map edge presentation, and the water/hydrology bridge before the principles-first rearchitecture pass. |
