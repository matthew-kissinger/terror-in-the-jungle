# Backlog Recently Completed Archive

Archived 2026-06-08 from [docs/BACKLOG.md](../BACKLOG.md) to keep the active
backlog as a compact current-work index. This file preserves historical cycle
closeout notes and old assumptions for audit/search only; current truth remains
in [docs/state/CURRENT.md](../state/CURRENT.md), [docs/DIRECTIVES.md](../DIRECTIVES.md),
[docs/CARRY_OVERS.md](../CARRY_OVERS.md), and [docs/BACKLOG.md](../BACKLOG.md).

Inline historical code paths were left as originally written. Explicit Markdown
links were adjusted for this archive location.
...
([docs/archive/FRAMEWORK_RECOVERY_PLAN_2026-05-20.md](FRAMEWORK_RECOVERY_PLAN_2026-05-20.md);
...
[docs/archive/CAMPAIGN_2026-05-20-VEHICLE-BOARDING-AND-WATER.md](CAMPAIGN_2026-05-20-VEHICLE-BOARDING-AND-WATER.md)
...
- [#191](https://github.com/matthew-kissinger/terror-in-the-jungle/pull/191) `rearch-browser-runtime-primitives` — archived `docs/archive/BROWSER_RUNTIME_PRIMITIVES_2026-05-13.md` memo (Rust-WASM, compute, audio, and related runtime primitives).
...
Comprehensive context: [docs/archive/STABILIZATION_CHECKPOINT_2026-05-09.md](STABILIZATION_CHECKPOINT_2026-05-09.md).
