...
Last verified: 2026-05-17 (cycles #1-#9 closed at fd646aeb / 7931d179 / b86cf027 / 73e777cb / f14400d2 / 78c9c55a / cycle #7 close-commit / cycle #8 close-commit / cycle #9 close-commit; current pointer = cycle #10 cycle-voda-3-watercraft; queue at 13 cycles via insertion of cycle-sun-and-atmosphere-overhaul at position #12)
...
#9 at the cycle close-commit (last R3 merge at `0791d73e` swapping
the TankAIGunnerRoute stub for the real TankBallisticSolver), the
current cycle pointer is at position #10
(`cycle-voda-3-watercraft`).** Cycles #1 through #9
are `done` in the queue below; 51 PRs merged across the nine cycles
(#208-#212, #214-#250, #251-#258), plus the out-of-band CI fix `47c42216`
