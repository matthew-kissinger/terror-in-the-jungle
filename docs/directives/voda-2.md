...
> buoyancy/swim/wade code paths named below (BuoyancyForce, PlayerSwimState,
> WadeSplashEffect, NPC water sampler) were removed in that strip; this memo is
> retained as history.
