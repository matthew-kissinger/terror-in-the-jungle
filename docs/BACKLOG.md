...
| slug | status | scope |
|---|---|---|
| `cycle-2026-06-13-world-systems-runtime-release` | active runtime release candidate; weapon pose, vehicle arcade-hybrid baseline, safe sky-dome cloud retune, and accepted jungle vegetation aggregate LOD are in scope; terrain/water/full forest/Nanite/default-on post remain no-go or gated | Ship player-facing runtime changes instead of another docs-only decision record, retain the accepted vegetation pass, keep strict memory/perf helper issues as explicit carry-forward diagnostics, commit and push `master`, deploy production, and pass `npm run check:live-release`. Brief: [docs/tasks/cycle-2026-06-13-world-systems-runtime-release.md](tasks/cycle-2026-06-13-world-systems-runtime-release.md). |
| `cycle-2026-06-13-world-systems-release-decision-run` | precursor release-decision run; proof/scaffold subset is GO, default-on terrain/water/sky/forest/HLOD/Nanite-lite expansions remain owner-gated until their specific proof gates pass | Audited latest `master` as the release candidate, decided ship/default-off/defer per Fable/world-systems lane, and preserved risky expansions as gated. Brief: [docs/tasks/cycle-2026-06-13-world-systems-release-decision-run.md](tasks/cycle-2026-06-13-world-systems-release-decision-run.md). |
| `cycle-2026-06-13-fable5-world-systems-debug-proofs` | shipped scaffold/proof subset; R1/R2/R3/R4 scaffolds plus terrain spike, strict-WebGPU gate proof, strict all-mode visual matrix, forest aggregate LOD planner, headed culling proof, trusted no-combat large-mode diagnostics, runtime primitive ownership tags, culling owner-path certification, and current A Shau quiet status-ok perf evidence recorded; future default-on terrain/water/sky/forest decisions remain owner-gated | Fold Fable5 heightfield/erosion, debug-only hydrology/water proof, WebGPU-only sky/cloud/post spike, generated Vietnam species specs, forest GPU culling/LOD, Nanite-lite aggregate evaluation, and renderer capability hardening into one TIJ-owned world-systems cycle without wholesale ports. Brief: [docs/tasks/cycle-2026-06-13-fable5-world-systems-debug-proofs.md](tasks/cycle-2026-06-13-fable5-world-systems-debug-proofs.md); predecessor analysis: [docs/rearch/FABLE5_WEBGPU_WORLD_SYSTEMS_2026-06-13.md](rearch/FABLE5_WEBGPU_WORLD_SYSTEMS_2026-06-13.md). |
