...
| slug | status | scope |
|---|---|---|
| `cycle-2026-07-01-owner-playtest-followups` | local hotfix code-complete; production owner review pending | 2026-07-01 testing follow-ups plus playtest hotfix: 3D map stripped from player-facing deploy/in-combat/pause paths in favor of the 2D tactical map, radio outer-ring click/right-click selection stabilized, LMG/non-shotgun tracer presentation centered, plus fal.ai objective/capture variant pools, local objective audio, radio IA/held equipment, smoke marker, and shot-origin ownership checks. Implementation record: [docs/rearch/JULY_1_PLAYTEST_IMPLEMENTATION_2026-07-01.md](rearch/JULY_1_PLAYTEST_IMPLEMENTATION_2026-07-01.md); source analysis: [docs/rearch/OWNER_PLAYTEST_INTAKE_2026-07-01.md](rearch/OWNER_PLAYTEST_INTAKE_2026-07-01.md). |
