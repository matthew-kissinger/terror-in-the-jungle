...
10. **Live production freshness is a recurring release gate.** The 2026-04-24 release was manually deployed, header-checked, and live-smoked, so the current `/build-assets/`, `/models/*`, and `titj-v2-2026-04-21` service-worker behavior is live. Repeat the manifest/header/live-smoke check after every push intended for player testing.
