...
| slug | status | scope |
|---|---|---|
| `cycle-2026-06-13-world-systems-release-decision-run` | active release-decision run; proof/scaffold subset is GO, default-on terrain/water/sky/forest/HLOD/Nanite-lite expansions remain owner-gated until their specific proof gates pass | Audit latest `master` as the release candidate, decide ship/default-off/defer per Fable/world-systems lane, deploy only the release-safe subset, and stop with artifacts if any required gate fails. Brief: [docs/tasks/cycle-2026-06-13-world-systems-release-decision-run.md](tasks/cycle-2026-06-13-world-systems-release-decision-run.md). |
