...
const GRANDFATHER: ReadonlySet<string> = new Set<string>([
  ...
  "docs/playtests/cycle-motor-pool-reflow-and-tank-dedup.md::missing_code_path::src/types/gameModeTypes.ts",
  "docs/rearch/CONTINUOUS_CONTACT_CONTRACT.md::missing_code_path::src/types/ContactInterfaces.ts",
  "docs/rearch/ENGINE_TRAJECTORY_2026-04-23.md::missing_code_path::src/engine/determinism",
  "docs/rearch/HEAP_RECOVERY_COMBAT120_TRIAGE.md::missing_code_path::scripts/perf-self-check.ts",
  ...
  "docs/rearch/PACKAGING_AND_ENGINE_REUSE_2026-05-16.md::missing_code_path::src/sw/service-worker.ts",
  "docs/rearch/PACKAGING_AND_ENGINE_REUSE_2026-05-16.md::missing_code_path::src/ui/menus/MainMenu.tsx",
  "docs/rearch/TANK_SYSTEMS_2026-05-13.md::missing_code_path::src/systems/vehicle/TankCannonProjectile.ts",
  "docs/rearch/deadcode-triage-2026-04-21.md::missing_code_path::scripts/npc-fw-pilot-trace.ts",
  "docs/rearch/deadcode-triage-2026-04-21.md::missing_code_path::src/systems/agent/index.ts",
  "docs/rearch/deadcode-triage-2026-04-21.md::missing_code_path::src/systems/vehicle/airframe/configs.ts",
  "docs/rearch/deadcode-triage-2026-04-21.md::missing_code_path::src/systems/vehicle/airframe/index.ts",
