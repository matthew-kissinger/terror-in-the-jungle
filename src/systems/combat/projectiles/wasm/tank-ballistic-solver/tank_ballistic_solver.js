...
/* @ts-self-types="./tank_ballistic_solver.d.ts" */
 ...
 */
export function solveTrajectoryFlat(v, angle, target_x, target_y, target_z, gravity) {
    const ret = wasm.solveTrajectoryFlat(v, angle, target_x, target_y, target_z, gravity);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./tank_ballistic_solver_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tank_ballistic_solver_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
