...
const PREFABS: Record<string, WorldFeaturePrefabDefinition> = {
  firebase_us_small: {
    placements: [
      { modelPath: StructureModels.FIREBASE_GATE, offset: new THREE.Vector3(0, 0, 12.5), yaw: 0 },
      { modelPath: StructureModels.GUARD_TOWER, offset: new THREE.Vector3(-15, 0, 15), yaw: Math.PI * 0.25, registerCollision: true },
      { modelPath: StructureModels.GUARD_TOWER, offset: new THREE.Vector3(15, 0, 15), yaw: -Math.PI * 0.25, registerCollision: true },
      { modelPath: StructureModels.COMMAND_TENT, offset: new THREE.Vector3(0, 0, -10), yaw: Math.PI },
      { modelPath: StructureModels.AMMO_BUNKER, offset: new THREE.Vector3(-11.25, 0, -7.5), yaw: Math.PI * 0.5 },
      { modelPath: StructureModels.AID_STATION, offset: new THREE.Vector3(11.25, 0, -7.5), yaw: -Math.PI * 0.5 },
      { modelPath: StructureModels.GENERATOR_SHED, offset: new THREE.Vector3(-7.5, 0, 2.5), yaw: Math.PI * 0.5 },
      { modelPath: StructureModels.WATER_TOWER, offset: new THREE.Vector3(8.75, 0, 3.75), yaw: 0, registerCollision: true },
      { modelPath: StructureModels.SUPPLY_CRATE, offset: new THREE.Vector3(-3.75, 0, 5), yaw: 0 },
      { modelPath: StructureModels.FUEL_DRUM, offset: new THREE.Vector3(3.75, 0, 5), yaw: 0 },
    ],
  },
  firebase_us_medium: {
    placements: [
      { modelPath: StructureModels.FIREBASE_GATE, offset: new THREE.Vector3(0, 0, 22.5), yaw: 0 },
      { modelPath: StructureModels.TOC_BUNKER, offset: new THREE.Vector3(0, 0, -12.5), yaw: Math.PI, registerCollision: true },
      { modelPath: StructureModels.GUARD_TOWER, offset: new THREE.Vector3(-20, 0, 17.5), yaw: Math.PI * 0.25, registerCollision: true },
      { modelPath: StructureModels.GUARD_TOWER, offset: new THREE.Vector3(20, 0, 17.5), yaw: -Math.PI * 0.25, registerCollision: true },
      { modelPath: StructureModels.BARRACKS_TENT, offset: new THREE.Vector3(-12.5, 0, -2.5), yaw: Math.PI * 0.5 },
      { modelPath: StructureModels.BARRACKS_TENT, offset: new THREE.Vector3(12.5, 0, -2.5), yaw: -Math.PI * 0.5 },
      { modelPath: StructureModels.AMMO_BUNKER, offset: new THREE.Vector3(-15, 0, -15), yaw: Math.PI * 0.5 },
      { modelPath: StructureModels.AID_STATION, offset: new THREE.Vector3(13.75, 0, -15), yaw: -Math.PI * 0.5 },
      { modelPath: StructureModels.COMMS_TOWER, offset: new THREE.Vector3(0, 0, 5), yaw: 0, registerCollision: true },
      { modelPath: StructureModels.WATER_TOWER, offset: new THREE.Vector3(17.5, 0, 2.5), yaw: 0, registerCollision: true },
    ],
  },
  ...
  firebase_hq_small: {
    placements: [
      { modelPath: StructureModels.TOC_BUNKER, offset: new THREE.Vector3(0, 0, -5), yaw: Math.PI, registerCollision: true },
      { modelPath: StructureModels.COMMS_TOWER, offset: new THREE.Vector3(-10, 0, 7.5), yaw: 0, registerCollision: true },
      { modelPath: StructureModels.COMMAND_TENT, offset: new THREE.Vector3(10, 0, 5), yaw: Math.PI * 0.5 },
      { modelPath: StructureModels.GENERATOR_SHED, offset: new THREE.Vector3(-6.25, 0, -12.5), yaw: Math.PI * 0.5 },
      { modelPath: StructureModels.AMMO_BUNKER, offset: new THREE.Vector3(8.75, 0, -12.5), yaw: -Math.PI * 0.5 },
      { modelPath: StructureModels.WATER_TOWER, offset: new THREE.Vector3(0, 0, 15), yaw: 0, registerCollision: true },
    ],
  },
