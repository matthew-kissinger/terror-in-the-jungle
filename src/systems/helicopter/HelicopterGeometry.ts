...
// the transport Huey + Cobra to the new Kiln GLBs by default; `?aircraftArt=legacy`
// restores the prior cycle-2026-06-11 repaint GLBs. The UH-1C gunship is HELD on
// legacy regardless of the flag: its Kiln GLB is scale-defective (~6.28 m long vs
// the legacy ~13.86 m), so the new art would ship a half-size gunship.
