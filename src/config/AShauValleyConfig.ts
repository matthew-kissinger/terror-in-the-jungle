...
export const A_SHAU_VALLEY_CONFIG: GameModeConfig = {
  ...
  terrain: {
    ...
    farCanopyTint: {
      ...
      startDistance: 480,
      endDistance: 3200,
      strength: 0.56, fogStrength: 0.78,
      coverageDistance: 4200, coverageStrength: 0.24, coverageScale: 360,
  ...
  terrainFlow: {
    ...
    routeTargetHeightMode: 'average',
    zoneShoulderPadding: 24,
    zoneShoulderBlend: 42,
    zoneShoulderGradeStrength: 0.08,
