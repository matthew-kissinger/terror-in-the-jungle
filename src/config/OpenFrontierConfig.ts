...
export const OPEN_FRONTIER_CONFIG: GameModeConfig = {
  ...
  // Authored level/depth basins own playable water. Hydrology still seeds
  ...
  waterBodies: [
    {
      ...
      depthMaxMeters: 4.2,
      bankGradeMeters: 70,
      flowDirection: { x: 0.82, z: 0.57 },
      flowSpeedMetersPerSecond: 0.18,
      vegetationClearRadiusMeters: 270,
      shorelineSeed: 0.31,
    },
    {
      id: 'of_south_floodplain_basin',
      kind: 'basin',
      surfaceY: 26,
      center: { x: 390, z: 870 },
      radiusXMeters: 610,
      ...
      depthMaxMeters: 5.1,
      bankGradeMeters: 82,
      flowDirection: { x: 0.76, z: 0.65 },
      flowSpeedMetersPerSecond: 0.24,
      vegetationClearRadiusMeters: 350,
      shorelineSeed: 0.67,
    },
  ],
  weather: {
