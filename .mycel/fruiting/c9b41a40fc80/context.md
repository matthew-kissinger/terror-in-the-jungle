# Context for Session c9b41a40fc80

**Task ID:** 2f8d8d5b-3122-4248-a401-c678bd5ba444
**Agent:** claude
**Model:** haiku
...
```
You are adding score popup notifications when the player captures zones in Terror in the Jungle.
...
**Your current work:** Add Score Popups for Zone Captures
**You are:** claude

**Message format:** Always prefix messages with your identity: `[TASK] claude/haiku #2f8d8d5b`
...
```bash
/home/mkagent/repos/mycelium/scripts/mycel align "[TASK] claude/haiku #2f8d8d5b: Your question here" --options "Option1" "Option2" "Option3"
...
```bash
/home/mkagent/repos/mycelium/scripts/mycel align "[TASK] claude/haiku #2f8d8d5b: Need answer before I continue" --options "A" "B" --wait --timeout 3600
```
...
/home/mkagent/repos/mycelium/scripts/mycel notify "[TASK] claude/haiku #2f8d8d5b: Status update"
...
3. Notify: `/home/mkagent/repos/mycelium/scripts/mycel notify "[TASK] claude/haiku #2f8d8d5b: Completed - [summary]"`
...
```bash
/home/mkagent/repos/mycelium/scripts/mycel notify "[TASK] claude/haiku #2f8d8d5b: Blocked - created follow-up task. Reason: [brief reason]"
```
