# Context for Session b18eec6889bf

**Task ID:** 394c1aaa-e439-4659-a4de-3f11a6b38369
**Agent:** claude
**Model:** sonnet
...
```
You are implementing hit markers for Terror in the Jungle, a 3D pixel art FPS game.
...
**Your current work:** Connect hit markers to weapon damage system
**You are:** claude

**Message format:** Always prefix messages with your identity: `[TASK] claude/sonnet #394c1aaa`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/sonnet #394c1aaa: Your question here" --options "Option1" "Option2" "Option3"
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/sonnet #394c1aaa: Need answer before I continue" --options "A" "B" --wait --timeout 3600
```
...
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #394c1aaa: Status update"
...
3. Notify: `/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #394c1aaa: Completed - [summary]"`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #394c1aaa: Blocked - created follow-up task. Reason: [brief reason]"
```
