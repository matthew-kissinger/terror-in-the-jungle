# Context for Session c2ce51f0fe24

**Task ID:** 25e69ccd-362d-4f9a-adc8-92cff174429c
**Agent:** claude
**Model:** haiku
**Timestamp:** 2026-01-24T21:03:54.570736
...
**Your current work:** Test counter - correct field
**You are:** claude

**Message format:** Always prefix messages with your identity: `[TASK] claude/haiku #25e69ccd`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/haiku #25e69ccd: Your question here" --options "Option1" "Option2" "Option3"
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/haiku #25e69ccd: Need answer before I continue" --options "A" "B" --wait --timeout 3600
```
...
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/haiku #25e69ccd: Status update"
...
3. Notify: `/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/haiku #25e69ccd: Completed - [summary]"`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/haiku #25e69ccd: Blocked - created follow-up task. Reason: [brief reason]"
```
