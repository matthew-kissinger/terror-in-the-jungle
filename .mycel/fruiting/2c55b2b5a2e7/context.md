# Context for Session 2c55b2b5a2e7

**Task ID:** 9af03dd7-8070-4cbd-aec5-7989869df15c
**Agent:** claude
**Model:** sonnet
...
```
# Task: Implement Post-Match Stats Screen
...
**Your current work:** Add post-match stats screen
**You are:** claude

**Message format:** Always prefix messages with your identity: `[TASK] claude/sonnet #9af03dd7`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/sonnet #9af03dd7: Your question here" --options "Option1" "Option2" "Option3"
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/sonnet #9af03dd7: Need answer before I continue" --options "A" "B" --wait --timeout 3600
```
...
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #9af03dd7: Status update"
...
3. Notify: `/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #9af03dd7: Completed - [summary]"`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #9af03dd7: Blocked - created follow-up task. Reason: [brief reason]"
```
