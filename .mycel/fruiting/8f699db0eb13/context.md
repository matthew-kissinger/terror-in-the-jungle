# Context for Session 8f699db0eb13

**Task ID:** 6770e688-b1c0-40ef-8060-eefa223861ff
**Agent:** claude
**Model:** sonnet
...
**Your current work:** Add NPC death animations with sprite transitions
**You are:** claude

**Message format:** Always prefix messages with your identity: `[TASK] claude/sonnet #6770e688`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/sonnet #6770e688: Your question here" --options "Option1" "Option2" "Option3"
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/sonnet #6770e688: Need answer before I continue" --options "A" "B" --wait --timeout 3600
```
...
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #6770e688: Status update"
...
3. Notify: `/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #6770e688: Completed - [summary]"`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #6770e688: Blocked - created follow-up task. Reason: [brief reason]"
```
