# Context for Session 9e233e7e476d

**Task ID:** acce4b36-3ee8-4d7b-8803-9b3e8945cf13
**Agent:** claude
**Model:** sonnet
...
**Your current work:** Add SMG weapon with high fire rate
**You are:** claude

**Message format:** Always prefix messages with your identity: `[TASK] claude/sonnet #acce4b36`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/sonnet #acce4b36: Your question here" --options "Option1" "Option2" "Option3"
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel align "[TASK] claude/sonnet #acce4b36: Need answer before I continue" --options "A" "B" --wait --timeout 3600
```
...
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #acce4b36: Status update"
...
3. Notify: `/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #acce4b36: Completed - [summary]"`
...
```bash
/home/mkagent/repos/mycelium/.venv/bin/mycel notify "[TASK] claude/sonnet #acce4b36: Blocked - created follow-up task. Reason: [brief reason]"
```
